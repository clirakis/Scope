/********************************************************************
 *
 * Module Name : FiltFilt.cpp
 *
 * Author/Date : C.B. Lirakis / 23-May-21
 *
 * Description : Generic FiltFilt
 *
 ...
 ******************************************************************
 *
 * Function Name : FiltFilt constructor
 *
 * Description :
 *
 * Inputs :
 ...
 *******************************************************************
 */
FiltFilt::FiltFilt (const Filt &p) : Filt(p)
{
    SET_DEBUG_STACK;
}
 ...
 *******************************************************************
 */
vector<double> FiltFilt::Do(vector<double>x)
{
...
#else
    cout << "FiltFilt not implemented." << endl;
#endif
    return filter_x;
}
#if 0
